...
/// Compile:
// g++ -I/usr/include spades.cpp -o spades -I /usr/local/lib -lmysqlcppconn
// 
// Execute:
// ./spades
// 
...
try {
 ...
 driver = get_driver_instance();
  ...
  /* Equivalent to entering mysql in the termimal */
  
con = driver->connect("tcp://127.0.0.1:3306", "root", "");

/* Connect to the MySQL music database */
    
 con->setSchema("music");   // Equivalent to "use music"
